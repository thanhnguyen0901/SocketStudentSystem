...
public static class LengthPrefixedJsonMessageWriter
{
    ...
    public static async Task WriteAsync<T>(Stream stream, T message, CancellationToken ct = default)
    {
        ...
        // ── Step 3: write header + payload in a single logical operation ──
        // Writing separately is fine on NetworkStream; both writes are buffered
        // by the OS TCP stack and will arrive as one or two IP segments.
